...
export default function AdminBookTitleManagementScreen() {
  ...
  const handleEdit = (id: string) => {
    router.push(`/(protected)/(product-admin)/(book-title)/${id}/edit`);
  };

  const goToBookDetails = (id: string) => {
    router.push(`/(protected)/(product-admin)/(book-title)/${id}/details`);
  };
  ...
  const handleAddBookTitle = () => {
    router.push("/(protected)/(product-admin)/(book-title)/new-book-title");
  };
