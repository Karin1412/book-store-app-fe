  ...
  return (
    <ThemedView style={styles.container}>
      <View style={styles.profileContainer}>
        ...
        <Text style={[styles.name, { color: textColor }]}>{currentUser.name}</Text>
        <Text style={[styles.email, { color: textColor }]}>{currentUser.email}</Text>

        <View style={[styles.infoBox, { borderColor }]}>
          <Text style={[styles.label, { color: textColor }]}>Số điện thoại:</Text>
          <Text style={[styles.value, { color: textColor }]}>{currentUser.phone}</Text>

          <Text style={[styles.label, { color: textColor }]}>Địa chỉ:</Text>
          <Text style={[styles.value, { color: textColor }]}>{currentUser.address}</Text>

          <Text style={[styles.label, { color: textColor }]}>Vai trò:</Text>
          <Text style={[styles.value, { color: textColor }]}>{currentUser.role}</Text>

          <Text style={[styles.label, { color: textColor }]}>Trạng thái:</Text>
          <Text style={[styles.value, { color: currentUser.isActive ? "green" : "red" }]}>
